...
def store_eye_positions1(eye_positions, filename='eye_positions1.json'):
...
def load_eye_positions(filename='eye_positions1.json'):
    try:
...
def open_eye_position_window1(canvas, back):
    ...
    def take_screenshot():
        ...
        screenshot.save('eye_positions1.png')
