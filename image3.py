...
def store_eye_positions3(eye_positions, filename='eye_positions3.json'):
...
def load_eye_positions(filename='eye_positions3.json'):
    try:
...
def open_eye_position_window3(canvas, back):
    ...
    def take_screenshot():
        ...
        screenshot.save('eye_positions3.png')
