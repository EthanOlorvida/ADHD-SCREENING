...
def store_eye_positions2(eye_positions, filename='eye_positions2.json'):
...
def load_eye_positions(filename='eye_positions2.json'):
    try:
...
def open_eye_position_window2(canvas, back):
    ...
    def take_screenshot():
        ...
        screenshot.save('eye_positions2.png')
