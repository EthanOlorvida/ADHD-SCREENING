...
def store_eye_positionsv(eye_positions, filename='eye_positionsv.json'):
...
def load_eye_positions(filename='eye_positionsv.json'):
    try:
...
def open_eye_position_windowv(canvas, back):
    ...
    def take_screenshot():
        ...
        screenshot.save('eye_positionsv.png')
