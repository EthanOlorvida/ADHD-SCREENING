...
def store_eye_positions4(eye_positions, filename='eye_positions4.json'):
...
def load_eye_positions(filename='eye_positions4.json'):
    try:
...
def open_eye_position_window4(canvas, back):
    ...
    def take_screenshot():
        ...
        screenshot.save('eye_positions4.png')
